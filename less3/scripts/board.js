let game = {
    ...
    /**
     * Генерируем игровую доску 8 на 8.
     */
    generateBoard() {
        let board = '';
    ...
    /**
     * Метод генерирует тег tr (строку игровой доски) с 
     * закрашенными тегами td (ячейками).
     */
    ...
    /**
     * Метод генерирует ячейку (тег td) с нужным 
     * классом цвета и координатами на поле.
     */
    ...
    /**
    * Метод вставляет на доску колонку слева,
    ...
    */
    ...
    /**
    * Метод создает строку (tr) с названиями колонок
    * в виде букв, а также в начале вставляет пустую
    * ячейку, которая идет под цифрами.
    */
    insertColsChars () {
